        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <PixelCard>
            <p className="font-secondary text-base md:text-lg leading-relaxed mb-6">
              Head of Content with 5+ years of experience generating demand and high-quality leads in SaaS and B2B Tech companies. Generated $12M+ in client revenue, boosted email engagement (open rate +52%, CTOR +5%, registration +194%), and produced content ranking #1 and #0. Led content, email, and LinkedIn growth and strategy for startups and mid-sized firms across SaaS and B2B Tech from early to growth stages.

Currently building expertise in the Web3, blockchain, and cryptocurrency space, connecting numbers to narratives, and translating data into insight and strategy. <strong>(open rate +52%, CTOR +5%, registration +194%)</strong>, and produced <strong>content ranking #1 and #0</strong>. Led content, email, and LinkedIn growth and strategy for startups and mid-sized firms across SaaS and B2B Tech from early to growth stages.
              <br /><br />
