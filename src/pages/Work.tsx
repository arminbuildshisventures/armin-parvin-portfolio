        ...
        <div className="container mx-auto max-w-6xl relative z-20">
          <Tabs defaultValue="case-studies" className="w-full">
            <div className="mb-16 flex justify-center">
              <TabsList className="md:pixel-border md:pixel-shadow-lg bg-transparent md:bg-card/50 md:backdrop-blur-sm md:p-2 flex flex-col md:inline-flex gap-3 md:gap-2 w-full md:w-auto p-0">
                <TabsTrigger 
                  value="case-studies" 
