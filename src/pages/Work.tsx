  ...
  const caseStudies: CaseStudy[] = [
    {
      ...
      challenge: "Convert.com needed to establish a strong brand presence in search results for their new features. The challenge was creating content that would rank well while also providing value to potential customers at the bottom of the funnel.",
      process: "Developed a comprehensive content strategy focusing on feature-specific content. Conducted keyword research, competitor analysis, and created detailed content briefs. Worked closely with the product team to understand technical specifications and translated them into accessible, SEO-optimized content.",
      outcome: "Successfully established Convert.com's presence in SERPs for target keywords. The content strategy led to increased organic traffic and improved brand recognition within the industry. Content pieces consistently ranked in top positions for competitive keywords.",
    ...
    },
    {
      ...
      challenge: "Roomvu faced low user registration rates and needed to significantly improve conversion through their email marketing efforts. The existing campaigns weren't engaging enough and lacked strategic automation.",
      process: "Redesigned the entire email marketing strategy from the ground up. Implemented advanced segmentation, created personalized drip campaigns, A/B tested subject lines and content, and developed automated workflows based on user behavior. Optimized send times and refined messaging to resonate with the real estate professional audience.",
      outcome: "Achieved a remarkable 194% increase in user registration rates. Email open rates improved by 50%+ and click-through rates increased by 23%+. The automated campaigns continued to drive consistent registrations with minimal manual intervention.",
      images: ["/placeholder.svg"],
    },
    {
      ...
      challenge: "Nordic Defender entered a highly competitive cybersecurity market with established players. They needed to differentiate their products and establish credibility quickly to gain market share.",
      process: "Conducted comprehensive market analysis to identify gaps and opportunities. Developed a unique positioning strategy highlighting Nordic Defender's strengths. Created a content marketing plan that emphasized thought leadership, technical expertise, and customer success stories. Produced whitepapers, technical guides, and case studies.",
      outcome: "Successfully positioned Nordic Defender as a credible player in the cybersecurity space. The content strategy generated qualified leads and established the brand as a thought leader. Market awareness increased significantly within the first six months.",
      images: ["/placeholder.svg"],
    },
    {
      title: "Cloudzy",
