  ...
  const selectedWork: WorkItem[] = [
    {
      ...
      workType: ["Marketing Email", "Sales Email"],
    ...
    },
    {
      ...
      workType: ["White Paper", "Blog", "Marketing Email", "Landing Page", "LinkedIn Post"],
    ...
    },
    {
      ...
      workType: ["Blog", "Marketing Email", "Landing Page"],
      industry: ["Technology"],
    ...
    },
    {
      ...
      workType: ["Blog", "White Paper", "Case Study"],
      industry: ["Technology"],
