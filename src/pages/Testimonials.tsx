        ...
        duration: 0.6
          ...
          <div className="mb-16 pixel-border bg-zinc-800 backdrop-blur-sm p-8 rounded-lg relative">
            ...
            <div className="relative w-full overflow-hidden">
              <div className="flex">
                {[...Array(3)].map((_, setIndex) => <div key={setIndex} className="flex gap-32 flex-shrink-0 animate-marquee">
                    {clientLogos.map((logo, index) => <div key={`${setIndex}-${index}`} className="flex items-center justify-center h-20 w-52 flex-shrink-0 hover:scale-110 transition-transform duration-300">
